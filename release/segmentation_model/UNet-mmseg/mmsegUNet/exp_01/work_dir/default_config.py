...
config_path = '/tf/P_stage/P_stage_segmentation/segmentation/semantic-segmentation-level2-cv-16/dev/model_develop/UNet/mmsegUNet/exp_01/mm_config/'
log_config = dict(
    by_epoch=False,
    interval=100,
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                entity='sang-hyun'),
            config_path=
            '/tf/P_stage/P_stage_segmentation/segmentation/semantic-segmentation-level2-cv-16/dev/model_develop/UNet/mmsegUNet/exp_01/mm_config/'
        )
    ])
