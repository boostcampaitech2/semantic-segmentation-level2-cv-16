...
'''
    ResUNet 3+ with deep supervision and class-guided module
'''
class ResUNet_3Plus_DeepSup_CGM(nn.Module):

    def __init__(self, in_channels=3, n_classes=1, feature_scale=4, is_deconv=True, is_batchnorm=True):
        super(ResUNet_3Plus_DeepSup_CGM, self).__init__()
        ...
        self.cls = nn.Sequential(
                    nn.Dropout(p=0.5),
                    nn.Conv2d(filters[3], n_classes, 1),
