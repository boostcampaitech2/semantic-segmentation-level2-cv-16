...
def train(data_dir, model_dir, args):
    ...
    # -- model
    config_path = '/opt/ml/segmentation/semantic-segmentation-level2-cv-16/dev/model_develop/HRNet/configs/hrnet_w18_seg_ocr.yaml'
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epochs", type=int, default=30, help="number of epochs to train (default: 25)"
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--name", default="23-8", help="model save at {SM_MODEL_DIR}/{name}"
    )
    ...
    wandb.run.name = f"{args.name}_HRNetV2_W18_OCR_rot+randomresizedcrop"
